public class yatsy {
	...
	public static void main(String[] args) {
		...
		// Kombinatsioonidega põhiküsimus: kas läbida kindlas järjekorras, lasta kasutajal valida või otsustada programmi sees?
		// Teha iga kombinatsiooni kontrollmehhanism. Kui ei täida tingimusi, läheb 0. Kuidas hea teostada?
		// Boonuspunktid esimese osa täieliku täitmise eest?
